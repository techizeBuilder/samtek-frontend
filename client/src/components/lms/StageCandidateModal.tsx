...
export default function StageCandidateModal({ isOpen, onClose }: StageCandidateModalProps) {
  ...
  // 🔥 THE FIX: Strip "Employee" (or Head/Manager) from the role to get the department (e.g., "Sales Employee" -> "Sales")
  ...
  const dynamicModules = allAvailableModules.filter((module: any) => {
    ...
    // Normalize frontend matching so "account" == "accounts"
        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto pr-2 custom-scrollbar">
          ...
          <div className="mb-6">
            ...
            {loadingTrainees ? (
              ...
              // 🔥 THE FIX: Updated the warning text to instruct HR to use the boolean flag
