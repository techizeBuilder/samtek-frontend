...
import { Check, X, Clock, Calendar, User, IndianRupee, FileText, ExternalLink, Loader2, Search } from 'lucide-react';
...
export default function ExpenseRequest() {
  ...
  // via `page`, see expenseRequestController.js getTeamExpenseRequests).
  ...
  const fetchRequests = async () => {
    try {
      ...
      const response = await api.get(`/expense-requests/manager?${params.toString()}`);
