...
import { Check, X, Clock, Calendar, User, FileText, AlertCircle, Search } from 'lucide-react';
...
export default function LeaveRequest() {
  ...
  // via `page`, see leaveController.js getAllLeaveRequests).
  ...
  const fetchRequests = async () => {
    try {
      ...
      const response = await api.get(`/leaves/manager?${params.toString()}`);
