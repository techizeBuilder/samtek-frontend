...
import { Check, X, Clock, Calendar, User, FileEdit, AlertCircle, Loader2, Search } from 'lucide-react';
...
export default function AttendanceRequest() {
  ...
  // via `page`, see attendanceRequestController.js getTeamAttendanceRequests).
  ...
  const fetchRequests = async () => {
    try {
      ...
      const response = await api.get(`/attendance-requests/manager?${params.toString()}`);
